...
/// Router that directs to appropriate workout detail view based on workout type
struct WorkoutDetailView: View {
    ...
    var body: some View {
        Group {
            if workout.type == .gym && workout.hasExerciseProgram {
                // Route to specialized gym workout view
                GymWorkoutDetailView(workout: workout, planManager: planManager)
            } else {
                // Route to standard interval-based workout view
                StandardWorkoutDetailView(workout: workout, planManager: planManager)
            }
        }
    }
}
...
struct StandardWorkoutDetailView: View {
    let workout: PlannedWorkout
    @ObservedObject var planManager: TrainingPlanManager
